...
def PlotStep_vorher(Q, Qm, btopo, Grid, titletext):
...
ilocal    = 1      # flag for local run
nhcrit    = 1.002  # criterion definition for local run (see hypy1d/factors_1_local.py in routine local_arrays)
iconvtest = 0
