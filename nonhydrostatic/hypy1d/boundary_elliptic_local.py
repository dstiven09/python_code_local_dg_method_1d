...
# LDG coefficients for Dirichlet boundary conditions
c11d = 1.
c12d = 1.
c22d = 0.
...
class LeftDirichlet:
  ...
  row of arr: determines the basis function, determining at which boundary (left or right) of the element we are
  ...
  def bc11(self):
    ...
    # element loop
    for ielmt in range(self.Local.elmtlenloc):
      eltdofs = self.Local.eltdofsloc[ielmt]
  ...
  def bc12(self):
    ...
    for ielmt in range(self.Local.elmtlenloc):
      ...
      if (ielmt>0):
        lcol.append(eltdofs[0] + self.Local.doflenloc)
        lrow.append(eltdofs[0])
        ldat.append(-0.5-c12d)
        lcol.append(eltdofs[0] -1 + self.Local.doflenloc)
        lrow.append(eltdofs[0])
        ldat.append(-0.5+c12d)
  ...
  def bc21(self):
    ...
    for ielmt in range(self.Local.elmtlenloc):
      ...
      if (ielmt>0):
        lcol.append(eltdofs[0]-1)
        lrow.append(eltdofs[0] + self.Local.doflenloc)
        ldat.append(-0.5-c12d)
        lcol.append(eltdofs[0])
        lrow.append(eltdofs[0] + self.Local.doflenloc)
        ldat.append(-0.5+c12d)
  ...
  def bc12(self):
    ...
    for ielmt in range(self.Local.elmtlenloc):
      ...
      if (ielmt>0):
        ...
        lcol.append(self.DGEl.doflength-1 + self.Local.doflenloc)
        lrow.append(0)
        ldat.append(-0.5+c12p)
        lcol.append(0 + self.Local.doflenloc)
        lrow.append(0)
        ldat.append(-0.5-c12p)
  ...
  def bc21(self):
    ...
    for ielmt in range(self.Local.elmtlenloc):
      ...
      if (ielmt>0):
        ...
        lcol.append(self.DGEl.doflength-1)
        lrow.append(0 + self.Local.doflenloc)
        ldat.append(-0.5-c12p)
        lcol.append(0)
        lrow.append(0 + self.Local.doflenloc)
        ldat.append(-0.5+c12p)
...
class RightDirichlet:
  ...
  def bc11(self):
    ...
    for ielmt in range(self.Local.elmtlenloc):
      ...
      if (ielmt<self.Local.elmtlenloc-1):
  ...
  def bc12(self):
    ...
    for ielmt in range(self.Local.elmtlenloc):
      ...
      if (ielmt<self.Local.elmtlenloc-1):
        lcol.append(eltdofs[-1] + self.Local.doflenloc)
        lrow.append(eltdofs[-1])
        ldat.append(0.5-c12d)
        lcol.append(eltdofs[-1] +1 + self.Local.doflenloc)
        lrow.append(eltdofs[-1])
        ldat.append(0.5+c12d)
  ...
  def bc21(self):
    ...
    for ielmt in range(self.Local.elmtlenloc):
      ...
      if (ielmt<self.Local.elmtlenloc-1):
        lcol.append(eltdofs[-1]+1)
        lrow.append(eltdofs[-1] + self.Local.doflenloc)
        ldat.append(+0.5-c12d)
        lcol.append(eltdofs[-1])
        lrow.append(eltdofs[-1] + self.Local.doflenloc)
        ldat.append(+0.5+c12d)
  ...
  def bc21(self):
    ...
    for ielmt in range(self.Local.elmtlenloc):
      ...
      if (ielmt<self.Local.elmtlenloc-1):
        ...
        lcol.append(self.DGEl.doflength-1)
        lrow.append(self.DGEl.doflength-1 + self.Local.doflenloc)
        ldat.append(+0.5+c12p)
        lcol.append(0)
        lrow.append(self.DGEl.doflength-1 + self.Local.doflenloc)
        ldat.append(+0.5-c12p)
